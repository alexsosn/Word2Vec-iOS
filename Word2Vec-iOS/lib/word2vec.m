...
+ (void)prapareWithTrainFile:(NSURL * _Nonnull) trainFile
    ...
    if (trainingIterations) iter = trainingIterations.longLongValue;
...
/*
 ...
 Parameters for training:
    ...
    -save-vocab <file>
       he vocabulary will be saved to <file>
    -read-vocab <file>
       he vocabulary will be read from <file>, not constructed from the training data
    -cbow <int>
