  ...
  var Trainer = function(net, options) {
    ...
    var options = options || {};
    self.learning_rate = typeof options.learning_rate !== 'undefined' ? options.learning_rate : 0.01;
    self.l1_decay = typeof options.l1_decay !== 'undefined' ? options.l1_decay : 0.0;
    self.l2_decay = typeof options.l2_decay !== 'undefined' ? options.l2_decay : 0.0;
    self.batch_size = typeof options.batch_size !== 'undefined' ? options.batch_size : 1;
    self.method = typeof options.method !== 'undefined' ? options.method : 'sgd'; // sgd/adam/adagrad/adadelta/windowgrad/netsterov

    self.momentum = typeof options.momentum !== 'undefined' ? options.momentum : 0.9;
    self.ro = typeof options.ro !== 'undefined' ? options.ro : 0.95; // used in adadelta
    self.eps = typeof options.eps !== 'undefined' ? options.eps : 1e-8; // used in adam or adadelta
    self.beta1 = typeof options.beta1 !== 'undefined' ? options.beta1 : 0.9; // used in adam
    self.beta2 = typeof options.beta2 !== 'undefined' ? options.beta2 : 0.999; // used in adam
